...
class CardView: UIView, UITextFieldDelegate, UIPickerViewDelegate, UIPickerViewDataSource {
    
    typealias EditCardViewOnClose = (CardView) -> Void
    var onClose: EditCardViewOnClose = { view in }
    ...
    lazy var card: CreateCard! = {
        ...
        c.createBtn.setTitle("Update Card", for: .normal)
        return c
    }()
